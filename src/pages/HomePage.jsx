    ...
    <div className="space-y-8 sm:space-y-xl pb-20 md:pb-32">
      ...
      <section className="relative min-h-[500px] sm:min-h-[640px] md:min-h-[720px] flex items-end overflow-hidden rounded-b-3xl">
        ...
        <div className="relative z-20 w-full px-4 sm:px-margin-mobile md:px-margin-desktop pb-12 sm:pb-16 md:pb-24 max-w-7xl mx-auto space-y-3 sm:space-y-4">
          ...
          <div className="inline-flex items-center gap-1.5 bg-surface/95 backdrop-blur-md px-3.5 py-1.5 rounded-full plate-shadow border border-white/20 animate-fade-in">
            <Star className="w-4 h-4 text-amber-600 fill-amber-600" />
            <span className="font-label text-xs sm:text-sm font-bold text-on-surface">
              4.7★ <span className="text-on-surface font-semibold opacity-90">(376 Google reviews)</span>
            </span>
          </div>
          ...
          <p className="font-body text-sm sm:text-xl text-white/95 max-w-xl italic leading-relaxed font-medium">
          ...
          <div className="flex flex-row gap-2.5 pt-1 sm:pt-2">
            <Link
              to="/menu"
              className="flex-1 sm:flex-none bg-primary-container hover:bg-opacity-90 text-on-primary-container font-label text-xs sm:text-sm font-bold px-4 sm:px-8 py-3.5 sm:py-4 rounded-2xl flex items-center justify-center gap-2 shadow-lg active:scale-95 transition-all text-center focus:ring-2 focus:ring-white"
              aria-label="Explore Golden Bowl Menu"
            >
            ...
            <a
              ...
              className="flex-1 sm:flex-none bg-secondary hover:bg-opacity-90 text-on-secondary font-label text-xs sm:text-sm font-bold px-4 sm:px-8 py-3.5 sm:py-4 rounded-2xl flex items-center justify-center gap-2 shadow-lg active:scale-95 transition-all text-center focus:ring-2 focus:ring-white"
        ...
        <div className="overflow-x-auto hide-scrollbar">
          <div className="flex items-center justify-between min-w-[580px] md:min-w-full px-2 sm:px-4">
            ...
            <Link 
              ...
              aria-label="Dine-in Information"
            >
              ...
              <div>
                ...
                <span className="text-xs text-on-surface font-semibold">Cozy Hearth Seating</span>
              </div>
            </Link>
            ...
            <a 
              ...
              aria-label="Home Delivery via WhatsApp"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white flex items-center justify-center text-primary shadow-sm group-hover:scale-110 transition-transform">
              ...
              <div>
                ...
                <span className="text-xs text-on-surface font-semibold">Fast in Hajipur</span>
              </div>
            </a>
            ...
            <Link 
              to="/events"
              className="flex items-center gap-2.5 group cursor-pointer"
              aria-label="Party Decorations Information"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white flex items-center justify-center text-primary shadow-sm group-hover:scale-110 transition-transform">
              ...
              <div>
                ...
                <span className="text-xs text-on-surface font-semibold">Birthday & Anniversary</span>
              </div>
            </Link>
            ...
            <Link 
              to="/dining" 
              className="flex items-center gap-2.5 group cursor-pointer"
              aria-label="Family Friendly Seating"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white flex items-center justify-center text-primary shadow-sm group-hover:scale-110 transition-transform">
              ...
              <div>
                ...
                <span className="text-xs text-on-surface font-semibold">Warm Ambiance</span>
              </div>
            </Link>
          ...
          <div className="md:w-1/2 relative w-full">
            ...
            <div className="rounded-2xl overflow-hidden plate-shadow border-4 border-white relative z-10">
              <img 
                ...
                alt="Golden Bowl Hajipur Cozy Restaurant Seating Area"
                width="600"
                height="450"
                loading="lazy"
                decoding="async"
          ...
          <div className="md:w-1/2 space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 pt-1 sm:pt-2">
              <div className="bg-surface p-3 sm:p-4 rounded-2xl border border-outline-variant/30">
                ...
                <span className="font-label text-xs text-on-surface font-semibold">Authentic Spices</span>
              </div>
              <div className="bg-surface p-3 sm:p-4 rounded-2xl border border-outline-variant/30">
                <span className="font-headline text-xl sm:text-2xl font-black text-primary block">Local</span>
                <span className="font-label text-xs text-on-surface font-semibold">Hajipur Favorite</span>
              </div>
            </div>
          </div>
      ...
      <section className="py-4 sm:py-6 px-3 sm:px-margin-mobile md:px-margin-desktop max-w-7xl mx-auto space-y-4">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="text-on-surface text-xs sm:text-sm mt-0.5 sm:mt-1 font-semibold">Hand-crafted flavors from our hearth kitchen.</p>
          </div>
          <Link 
            to="/menu"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-6">
          {signatureDishes.map((dish) => (
            ...
            >
              <div>
                <Link to={`/dish/${dish.id}`} className="relative h-32 sm:h-48 block overflow-hidden" aria-label={`View details for ${dish.name}`}>
                  <img 
                    src={dish.image} 
                    alt={dish.name}
                    width="300"
                  ...
                  />
                  <div className="absolute top-1.5 left-1.5 sm:top-3 sm:left-3 bg-primary text-white font-label text-[10px] sm:text-xs font-bold px-2 sm:px-3 py-0.5 sm:py-1 rounded-full shadow-md">
                    Bestseller
                  </div>
                </Link>
                ...
                <div className="p-2.5 sm:p-5">
                  ...
                  <p className="font-body text-xs text-on-surface font-medium line-clamp-2 leading-tight sm:leading-relaxed mb-2 sm:mb-4">
                    {dish.description}
                  </p>
                </div>
              </div>
              ...
              <div className="p-2.5 sm:p-5 pt-0 flex items-center justify-between">
                ...
                <button
                  ...
                  className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-primary-container text-on-primary-container flex items-center justify-center hover:bg-primary hover:text-white transition-colors active:scale-90 shadow-sm focus:ring-2 focus:ring-primary"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div className="bg-surface p-5 sm:p-8 rounded-3xl plate-shadow relative border-l-4 border-primary space-y-3">
            ...
            <div className="flex gap-1">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="w-4 h-4 text-amber-600 fill-amber-600" />
              ))}
            </div>
            <p className="font-body text-xs sm:text-base text-on-surface italic font-medium leading-relaxed">
      ...
      <section className="px-3 sm:px-margin-mobile md:px-margin-desktop max-w-7xl mx-auto">
        <div className="bg-primary text-on-primary rounded-3xl p-6 sm:p-12 text-center plate-shadow relative overflow-hidden space-y-3 sm:space-y-4">
          ...
          <p className="font-body text-xs sm:text-base opacity-95 max-w-lg mx-auto leading-relaxed font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-2.5 justify-center pt-2">
            <a 
              ...
              aria-label="Order food via WhatsApp now"
            >
              WhatsApp Order Now
            </a>
            <button
              onClick={() => setIsReservationOpen(true)}
              className="border-2 border-white/60 text-white font-bold px-6 py-3.5 rounded-full flex items-center justify-center gap-2 hover:bg-white/10 transition-colors active:scale-95 text-xs sm:text-sm"
              aria-label="Book a table at outlet"
            >
