...
export const DiningPage = () => {
  ...
  return (
    <div className="pb-24 md:pb-32 px-margin-mobile md:px-margin-desktop max-w-7xl mx-auto space-y-10 animate-fade-in pt-6">
      ...
      {/* Hero Banner */}
      <section className="relative rounded-3xl overflow-hidden min-h-[440px] flex items-end p-8 md:p-12 border border-outline-variant/30 plate-shadow">
        <div 
        ...
        <div className="relative z-20 space-y-4 max-w-2xl">
          ...
          <button
            ...
            className="bg-primary text-on-primary font-bold px-8 py-3.5 rounded-full text-sm flex items-center gap-2 hover:bg-opacity-90 active:scale-95 transition-all shadow-md"
          >
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {diningFeatures.map((item, idx) => {
          ...
          return (
            <div key={idx} className="bg-surface-container-low p-8 rounded-3xl border border-outline-variant/30 plate-shadow space-y-4">
      ...
      <section className="bg-surface p-8 rounded-3xl border border-outline-variant/30 plate-shadow flex flex-col md:flex-row items-center justify-between gap-6">
